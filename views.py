...
def comp(request):
    if request.method == "POST":
        ...
        if form.is_valid():
            try:
                form.save()
                return redirect('ecom/show.html')
            except:
                pass
    else:
        form = CompanyForm()
    return render(request, 'ecom/addcomp.html', {'form': form})


# To retrieve Company details
def show(request):
    companies = Company.objects.all()
    return render(request, 'ecom/show.html', {'companies': companies})


# To Edit Company details
def edit(request, cName):
    company = Company.objects.get(cName=cName)
    return render(request, 'ecom/edit.html', {'company': company})
    ...
    if request.method == "POST":
        ...
        if form.is_valid():
            try:
                ...
                form.save()
                return redirect('ecom/showemp.html')
            except:
                pass
    else:
        form = EmployeeForm()
    return render(request, 'ecom/addemp.html', {'form': form})


# To show employee details
def showemp(request):
    employees = Employee.objects.all()
    return render(request, 'ecom/showemp.html', {'employees': employees})
...
def editemp(request, eFname):
    employee = Employee.objects.get(eFname=eFname)
    return render(request, 'ecom/editemployee.html', {'employee': employee})
